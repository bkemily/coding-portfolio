...
function SafeWellSubmission() {
    ...
    const mappedCheckboxOptions = checkboxOptions.map(option => {
        return (
            <div className="form-check my-2" key={option}>
                <input type="checkbox" className="form-check-input" name="safeLocations" value={option} onChange={handleChange} />
            ...
            <form onSubmit={handleSubmit} className="mt-3">
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <input type="text" name="firstName" value={formData.firstName} onChange={handleChange} className="form-control" placeholder="Enter your First Name" />
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="text" name="lastName" value={formData.lastName} onChange={handleChange} className="form-control" placeholder="Enter your Last Name" />
                ...
                <input type="tel" name="phoneNumber" value={formData.phoneNumber} onChange={handleChange} className="form-control" placeholder="123-456-7890" />
                ...
                <input type="email" name="emailAddress" value={formData.emailAddress} onChange={handleChange} className="form-control" placeholder="example@email.com" />
                ...
                <label className="required-label">Home Address:</label>
                <input type="text" name="homeAddress" value={formData.homeAddress} onChange={handleChange} className="form-control" placeholder="Home Address Line 1" />
                {errors.homeAddress && <div className="alert alert-danger mt-2">{errors.homeAddress}</div>}

                <label>Home Address (Line 2):</label>
                <input type="text" name="homeAddress2" value={formData.homeAddress2} onChange={handleChange} className="form-control" placeholder="Apartment, Suite, etc. (optional)" />

                <label className="required-label">Home City:</label>
                <input type="text" name="homeCity" value={formData.homeCity} onChange={handleChange} className="form-control" placeholder="City" />
                {errors.homeCity && <div className="alert alert-danger mt-2">{errors.homeCity}</div>}

                <label className="required-label">Home State:</label>
                <input type="text" name="homeState" value={formData.homeState} onChange={handleChange} className="form-control" placeholder="State" />
                ...
                <input type="text" name="homeZipCode" value={formData.homeZipCode} onChange={handleChange} className="form-control" placeholder="12345 or 12345-6789" />
                ...
                <label className="required-label">Safe and Well Notice:</label>
                ...
                <textarea name="message" value={formData.message} onChange={handleChange} className="form-control" rows="3" placeholder="Enter any additional information..."></textarea>
